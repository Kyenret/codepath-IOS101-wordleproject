...
class WordGenerator {
  ...
  static let possibleWords = ["HELLO", "BRUTE", "JESUS", "SAUCE", "BEANS", "BARTS", "STAUB", "NEEDS", "TRUCE", "CRATE", "SHADE", "BLAME","TROOP", "FAITH", "AUDIO", "START", "TODAY", "OCEAN", "SPARE", "SPAIN", "NAPLE", "TIMES", "BLOOM", "LYRIC", "SHARE", "SHOES"] //add more possible words
