...
import UIKit  //Imports UIKit framework
...
class KeyboardController: NSObject,
  ...
  func collectionView(_ collectionView: UICollectionView,
    ...
    // START YOUR CODE HERE
      cell.didSelectString = didSelectString //closure property that is being called when i click on a cell and takes the string as argument
